...
export default function SubModulDetail() {
    let { idModule, idSubModule,idFormation} = useParams();
    ...
    const submodules=module.submodules.find((mod)=>mod.idSubModule===idSubModule)
    ...
    function ListModule({listitem}){
      ...
      function Itemlist({item,listitem}){
        ...
        function ListItem ({t}){
          ...
          const prog=submodules.context[item].lesmodules[t]
        ...
        function Listmodul ({t}){
          const context=submodules.context[t]
         if(t.includes("text")){
        ...
        return (
          ...
          <div class="left"> <img src={module.imgModul}   alt={module.imgModul}/></div>
          <div class="right">     <h1 className='titleHead'> {submodules.nomSubModule}   </h1></div>
         </div>    
     <br/>
     <div className='contentModule'>
     <div className='blocleftModel3'>
      <ListModule listitem={submodules.forma}/>
      </div>
     ...
     <h2 className='titresouligne'> Qui sommes nous :</h2>
